...
def send_approval_email(to_email, teammate_email, team_name, username, password):
    """
    Sends a styled HTML credentials email via Resend to both the primary
    registrant and the teammate (if they provided an email).
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Dear Team,</p>
                <p>We are excited to inform you that your registration for <strong>Infacto 5.0</strong> has been approved.</p>
                <p>Use the following auto-generated credentials to access your participant dashboard, where you can view your debate topic, stance, scheduled slots, and classroom assignments.</p>
...
Your registration for Infacto 5.0 has been approved.

Dashboard: https://infacto-six.vercel.app/login.html
Team Name: {team_name}
Login ID:  {username}
Password:  {password}
...
Orator Club, IIIT Nagpur
    ...
    try:
        ...
        print(f"[Resend] Email sent successfully. ID: {response.get('id')} → {recipients}")
        return True
    except Exception as e:
        print(f"[Resend] Failed to send email to {recipients}: {e}")
        return False
